...
export type Database = {
  ...
  public: {
    Tables: {
      bill_instances: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "bill_instances_recurring_bill_id_fkey"
      ...
      categories: {
        Row: {
          ...
          id: string
          name: string
          type_default: Database["public"]["Enums"]["category_type"] | null
          user_id: string
        }
        Insert: {
          color?: string | null
    ...
    Enums: {
      category_type: "essential" | "discretionary" | "investment" | "income"
      notification_type:
        | "bill_due"
        | "bill_overdue"
        | "budget_exceeded"
        | "info"
      transaction_kind: "fixed" | "variable" | "investment" | "income"
